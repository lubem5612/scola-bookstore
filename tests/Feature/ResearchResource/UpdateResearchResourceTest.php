...
class UpdateResearchResourceTest extends TestCase
{
    private $faker;
    public function setUp(): void
    {
        ...
        /** @test */
    public function can_update_research_resource_via_action()
    {
        $response = (new UpdateResearchResource($this->request))->execute();
    ...
    /** @test */
    function can_update_research_resource_successfully()
    {
        $response = $this->json('PATCH', "bookstore/research_resources/{$this->researchResource->id}", $this->request, ['Accept' => 'application/json']);
