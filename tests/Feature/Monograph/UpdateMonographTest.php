...
class UpdateMonographTest extends TestCase
{
    private $faker;
    public function setUp(): void
    {
        parent::setUp();
        $this->monograph = Monograph::factory()->create();
        ...
        /** @test */
    public function can_update_monograph_via_action()
    {
        $response = (new UpdateMonograph($this->request))->execute();
    ...
    /** @test */
    function can_update_monograph_successfully()
    {
        $response = $this->json('PATCH', "bookstore/monographs/{$this->monograph->id}", $this->request, ['Accept' => 'application/json']);
