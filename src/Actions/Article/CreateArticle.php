...
class CreateArticle
{
    ...
    private function uploadCoverImage()
    {
        ...
        {
            $response = $this->uploader->uploadFile($this->formData['cover_image'], 'bookstore/resources');
    ...
    private function validateRequest()
    {
        $this->formData = $this->validate($this->request, [
            ...
            'contributors.*' => 'required_if:contributors,!=,null|string|name',
            ...
            'conference_info.*' => 'required_if:conference_info,!=,null|in:name,date,location',  // validate 'name, year, date, location';
            'institutional_affiliations' => 'nullable|array',
            'institutional_affiliations.*' => 'required_if:institutional_affiliations,!=,null|string|in:name',
